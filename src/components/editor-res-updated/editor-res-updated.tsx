...
//   @State() component: boolean = false;
  ...
  render() {
    return (
      <Host>
        <table-wrapper-updated data={this.result} api={this.api} autocompute={false} headerList={this.headerList} rowPerPage={[50, 10, 20, 30]}></table-wrapper-updated>
      </Host>
    );
  }
}
