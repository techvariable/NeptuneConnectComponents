                  ...
                  <div class="px-2 flex justify-between bg-white rounded svelte-1l8159u">
                    <div class="w-full gap-2 flex flex-auto py-1 flex-wrap">
                      {Object.keys(this.sortchips).map(item => {
                        ...
                        return (
                          <div
                            title={`${item} is sorted in ${this.sortchips[item]} order`}
                            class="flex justify-center items-center m-1 font-normal py-1 px-2 rounded-full border bg-gray-100"
                          >
                      ...
                      {Object.keys(this.searchChips).map(item => {
                        ...
                        return (
                          <div
                            title={`${item} is searched by ${value} in ${key} pattern`}
                            class="flex justify-center items-center m-1 font-normal py-1 px-2 rounded-full border bg-gray-100"
                          >
                            ...
                            {
                              <span class="ml-2">
                                <span class="text-xs">by</span> {value}
                              </span>
                            }
